...
# 什么是业务过程
业务过程是公司关键运营动作的抽象，如投放域：素材上传、素材打标签、创建广告、广告曝光、广告归因等业务过程。
有三点特征：
1. 事件驱动​​：由用户/系统动作触发（如优化师创建广告计划）。
2. ​​有具体的可量化指标​​：输出可量化的绩效指标（如广告曝光中的pv、uv，“订单金额”“发货时效”）。
3. 有系统支持​​：通常由独立业务系统承载（如投放后台的创建广告，订单系统支持“下单”过程）

# 怎么定义好业务过程
1. ​业务调研​​：与业务方确认核心指标及其来源事件（如“广告曝光量”关联“创建广告”过程）。
2. ​​原子事件拆分​​：
    例如“广告投放”可拆解为：
        创建账户（独立过程）
        上传素材（独立过程，因涉及第三方服务）
